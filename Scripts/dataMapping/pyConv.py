...
if uploadedFile:
    ...
    if True:
        ...
        if uc:
            df = remove_rcna(df)
            weight_pages = ["Pounds", "Kilograms", "Milligrams"]
            length_pages = ["Inches", "Meters", "Centimeters"]
        ...
        if datamelt:
            ...
            cols = st.text_input("Input the columsn you would like to melt seperated by commas")
            if cols:
                dataCols = cols.split (",")
